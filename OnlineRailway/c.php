...
echo"<tr><td><h1>Amount Left in Account</h1></td><td><h1>Credit card number</h1></td></td><td><h1>Pin</h1></td></tr>";
...
echo"<tr><td>".$row["initial"]."</td><td>".$row["ccn"]."</td><td>".$row["pin"]."</td></tr>";
 }
}
echo"</table>";
echo"</center>";
